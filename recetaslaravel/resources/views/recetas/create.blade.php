...
@section('content')
    ...
    <h2 class="text-center mb-5">Crear una nueva receta</h2>
        ...
        <div class="col-md-8">
            <form method="POST" action="{{ route('recetas.store') }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group mt-3">
                    ...
                    <input id="preparacion" type="hidden" name="preparacion" value="{{ old('perparacion') }}">
                    <trix-editor 
                ...
                <div class="form-group mt-3">
                    ...
                    <input id="ingredientes" type="hidden" name="ingredientes" value="{{ old('perparacion') }}">
                    <trix-editor 
